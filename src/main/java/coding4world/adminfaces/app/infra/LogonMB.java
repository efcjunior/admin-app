package coding4world.adminfaces.app.infra;
 ...
 * must be redirect to initial page or logon you can remove this class.
 */
@Named
@SessionScoped
@Specializes
public class LogonMB extends AdminSession implements Serializable {
	...
	public void login() throws IOException {
		currentUser = email;
		FacesMessage facesMessage = Messages.create("")
				.detail("Logged in successfully as <b>" + email + "</b>").get();
